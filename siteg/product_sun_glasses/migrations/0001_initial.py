...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Sun_glasses_frame_material',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frame_material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_frame_material', verbose_name='Материал оправы')),
                ('frame_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_frame_type', verbose_name='Тип оправы')),
                ('glasses_form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_form', verbose_name='Форма очков')),
                ('glasses_gender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_gender', verbose_name='Пол')),
                ('glasses_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_size', verbose_name='Размер очков')),
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_sun_glasses.sun_glasses_manufacturer', verbose_name='Производитель')),
            ],
            options={
