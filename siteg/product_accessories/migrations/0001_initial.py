    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manufacturer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_accessories.accessories_manufacturer', verbose_name='Производитель')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product_accessories.accessories_type', verbose_name='Тип')),
            ],
            options={
